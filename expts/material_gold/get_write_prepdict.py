...
def main():
    all_num = 0
    args_file = 'args_nopretrain_1000.json'
    ...
    for basedir, subdirs in tmp.items():
        for subdir in subdirs:
            ...
            for task in TASKS:
                ...
                #       '/export/a08/fwang/tfmtl/expts/material_gold/' \
                #       + args_file + \
                #       ' /export/a08/fwang/tfmtl/expts/material_gold/data/json/predict/' + dir + '/data.json.gz' + \
                #       ' /export/a08/fwang/tfmtl/expts/material_gold/data/tf/predict/' + dir + '/' + task[:3] + dataset_path \
                #       + 'predict.tf' + \
                #       ' /export/a08/fwang/tfmtl/expts/material_gold/data/tf/single/' + task + dataset_path
                ...
                args_file_path = '/export/a08/fwang/tfmtl/expts/' \
                                 '/material_gold/' + args_file + ' '
                json_path = '/export/a08/fwang/tfmtl/expts/material_gold/data/json' \
                            '/predict' \
                            '/' + dir + '/data.json.gz '
                tf_path = '/export/a08/fwang/tfmtl/expts/material_gold/data/tf' \
                          '/predict' \
                          '/' + dir + '/' + dataset_tf_name + dataset_path + 'predict.tf'
                arch_path = '/export/a08/fwang/tfmtl/expts/material_gold/data/tf/single/' + \
                            task + dataset_path
                ...
                #       '/export/a08/fwang/tfmtl/expts/material_gold/write.e ', job_name)
