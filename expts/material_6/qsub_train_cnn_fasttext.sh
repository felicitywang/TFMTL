#!/bin/sh
#$ -cwd
#$ -o /export/a08/fwang/tfmtl/expts/material_6/cnn_fasttext.o
#$ -e /export/a08/fwang/tfmtl/expts/material_6/cnn_fasttext.e
#$ -M fwang40@jhu.edu
...
CUDA_VISIBLE_DEVICES=`free-gpu` python ../scripts/discriminative_driver.py \
       ...
       --mode train \
       --num_train_epochs 50 \
       --checkpoint_dir ./data/ckpt/cnn_fasttext/ \
       ...
       --architecture cnn_expand_fasttext \
       --shared_mlp_layers 1 \
