...
def accuracy_score(y_true, y_pred):
  return sklearn.metrics.accuracy_score(y_true=y_true,
                                        y_pred=y_pred,
                                        normalize=True  # return fraction
                                        )


def accurate_number(y_true, y_pred):
  return sklearn.metrics.accuracy_score(y_true=y_true,
                                        y_pred=y_pred,
...
def mae_macro(y_true, y_pred):
  ...
  :return: float
  """
  return sklearn.metrics.mean_absolute_error(y_true=y_true,
                                             y_pred=y_pred,
                                             sample_weight=None,
...
if __name__ == '__main__':
  ...
  print(accurate_number(y_true=y_true, y_pred=y_pred))

  print(mae_macro(y_true=y_true, y_pred=y_pred))

  print(recall_macro(y_true=y_true, y_pred=y_pred, labels=labels))
  print(f1_macro(y_true=y_true, y_pred=y_pred, labels=labels))
