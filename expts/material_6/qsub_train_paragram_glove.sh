#!/bin/sh
#$ -cwd
#$ -o /export/a08/fwang/tfmtl/expts/material_6/paragram_glove.o
#$ -e /export/a08/fwang/tfmtl/expts/material_6/paragram_glove.e
#$ -M fwang40@jhu.edu
...
CUDA_VISIBLE_DEVICES=`free-gpu` python ../scripts/discriminative_driver.py \
       ...
       --mode train \
       --num_train_epochs 50 \
       --checkpoint_dir ./data/ckpt/paragram_glove/ \
