...
from mtl.util.util import bag_of_words
    ...
    def __init__(self,
        ...
        if len(self._unlabeled_index) == 0:
            ...
            self.write_examples(self._unlabeled_path,
                                self._unlabeled_index, write_bow, labeled=False)
