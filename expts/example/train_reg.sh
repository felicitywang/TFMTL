python ../scripts/discriminative_driver.py \
       ...
       --topics_path data/json/GOV_turk/data.json.gz \
       ...
       --private_hidden_dims 128 128 \
       --alphas 1 \
       --optimizer rmsprop \
       --lr0 0.001 \
       --seed 42 \
       --summaries_dir ./data/summ/GOV_turk_reg/ \
       --checkpoint_dir ./data/ckpt/GOV_turk_nopretrain/ \
       --log_file ./data/logs/GOV_turk_nopretrain.log \
       --tuning_metric MSE \
       --metrics MSE Acc
