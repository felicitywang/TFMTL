python ../scripts/discriminative_driver.py \
       ...
       --architecture meanmax_relu_0.1_glove_only_nofinetune_proj_100 \
       --shared_mlp_layers 0 \
       ...
       --lr0 0.001 \
       --seed 42 \
       --summaries_dir ./data/summ/SSTb_glove_only_nofinetune_proj_100/ \
       --checkpoint_dir ./data/ckpt/SSTb_glove_only_nofinetune_proj_100/ \
       --log_file ./data/logs/SSTb_glove_only_nofinetune_proj_100.log \
       --tuning_metric Acc \
