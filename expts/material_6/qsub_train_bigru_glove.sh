#!/bin/sh
#$ -cwd
#$ -o /export/a08/fwang/tfmtl/expts/material_6/bigru_glove.o
#$ -e /export/a08/fwang/tfmtl/expts/material_6/bigru_glove.e
#$ -M fwang40@jhu.edu
...
CUDA_VISIBLE_DEVICES=`free-gpu` python  ../scripts/discriminative_driver.py \
       ...
       --mode train \
       --num_train_epochs 50 \
       --checkpoint_dir ./data/ckpt/bigru_glove/ \
       ...
       --architecture bigru_expand_glove \
       --shared_mlp_layers 1 \
