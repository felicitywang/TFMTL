...
class EmbedTests(tf.test.TestCase):
  ...
  def test_template(self):
    ...
    with self.test_session() as sess:
      ...
      seq1_tmp_val, seq1_outputs_val, seq1_last_state_val, seq2_tmp_val, seq2_outputs_val, seq2_last_state_val = sess.run([seq1_tmp, seq1_outputs, seq1_last_state, seq2_tmp, seq2_outputs, seq2_last_state])
