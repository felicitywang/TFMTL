python ../scripts/discriminative_driver.py \
       ...
       --datasets SSTb \
       --class_sizes 5 \
       --dataset_paths data/tf/single/SSTb_finetune/min_1_max_-1_vocab_-1_doc_-1_tok_tweet/ \
       --topics_path data/finetune/SSTb_neg/json/data.json.gz \
       ...
       --lr0 0.001 \
       --seed 42 \
       --summaries_dir ./data/summ/SSTb_finetune/ \
       --checkpoint_dir_init ./data/ckpt/SSTb_nopretrain/ \
       --checkpoint_dir ./data/ckpt/SSTb_finetune/ \
