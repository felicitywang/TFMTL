#!/bin/sh
#$ -cwd
#$ -o /export/a08/fwang/tfmtl/expts/material_6/nopretrain.o
#$ -e /export/a08/fwang/tfmtl/expts/material_6/nopretrain.e
#$ -M fwang40@jhu.edu
#$ -l 'gpu=1,mem_free=20G,ram_free=20G,hostname="b1*|c*"''
#$ -pe smp 2
#$ -V
#$ -q g.q
...
CUDA_VISIBLE_DEVICES=`free-gpu` python ../scripts/discriminative_driver.py \
       ...
       --mode train \
       --num_train_epochs 50 \
       --checkpoint_dir ./data/ckpt/nopretrain/ \
