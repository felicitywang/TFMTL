...
def main(adjacencies_file, cluster_groupings_file, cluster_names_file, from_dbpedia=False):
    ...
    if from_dbpedia:
        G = make_wiki_adjacencies.add_adjacencies(graph_manip.DiGraph(), adjacencies_file)
    else:
...
if __name__ == '__main__':
    ...
    main(args.adjacencies_file, args.cluster_groupings_file, args.cluster_names_file, from_dbpedia=args.from_dbpedia)
