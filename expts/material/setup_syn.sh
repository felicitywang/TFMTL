...
cp /export/a05/mahsay/domain/data/json/syn/p1000r1000/clean/LIF/data.json.gz data/json/LIF_syn_p1000r1000/data.json.gz
cp /export/a05/mahsay/domain/data/json/syn/p1000r1000/clean/BUS/data.json.gz data/json/BUS_syn_p1000r1000/data.json.gz
cp /export/a05/mahsay/domain/data/json/syn/p1000r1000/clean/LAW/data.json.gz data/json/LAW_syn_p1000r1000/data.json.gz
cp /export/a05/mahsay/domain/data/json/syn/p1000r1000/clean/HEA/data.json.gz data/json/HEA_syn_p1000r1000/data.json.gz
cp /export/a05/mahsay/domain/data/json/syn/p1000r1000/clean/MIL/data.json.gz data/json/MIL_syn_p1000r1000/data.json.gz
cp /export/a05/mahsay/domain/data/json/syn/p1000r1000/clean/SPO/data.json.gz data/json/SPO_syn_p1000r1000/data.json.gz
