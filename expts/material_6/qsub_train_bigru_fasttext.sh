#!/bin/sh
#$ -cwd
#$ -o /export/a08/fwang/tfmtl/expts/material_6/bigru_fasttext.o
#$ -e /export/a08/fwang/tfmtl/expts/material_6/bigru_fasttext.e
#$ -M fwang40@jhu.edu
...
CUDA_VISIBLE_DEVICES=`free-gpu` python  ../scripts/discriminative_driver.py \
       ...
       --mode train \
       --num_train_epochs 50 \
       --checkpoint_dir ./data/ckpt/bigru_fasttext/ \
       ...
       --architecture bigru_expand_fasttext \
       --shared_mlp_layers 1 \
