python ../scripts/discriminative_driver.py \
       ...
       --architecture bilstm_attention_3_nopretrain \
       --shared_mlp_layers 0 \
       ...
       --lr0 0.001 \
       --seed 42 \
       --summaries_dir ./data/summ/SST2_nopretrain_bilstm3/ \
       --checkpoint_dir ./data/ckpt/SST2_nopretrain_bilstm3/ \
       --log_file ./data/logs/SST2_nopretrain_bilstm3.log \
       --tuning_metric Acc \
