python ../scripts/discriminative_driver.py \
       ...
       --datasets Topic2 \
       --dataset_paths data/tf/single/Topic2/min_1_max_-1_vocab_-1_GoogleNews-vectors-negative300_init \
       --class_sizes 2 \
       --vocab_size_file data/tf/single/Topic2/min_1_max_-1_vocab_-1_GoogleNews-vectors-negative300_init/vocab_size.txt \
