#!/bin/sh
#$ -cwd
#$ -o /export/a08/fwang/tfmtl/expts/material_6/bilstm_glove.o
#$ -e /export/a08/fwang/tfmtl/expts/material_6/bilstm_glove.e
#$ -M fwang40@jhu.edu
...
CUDA_VISIBLE_DEVICES=`free-gpu` python ../scripts/discriminative_driver.py \
       ...
       --mode test \
       --num_train_epochs 30 \
       --checkpoint_dir ./data/ckpt/bilstm_glove/ \
       ...
       --architecture bilstm_expand_glove \
       --shared_mlp_layers 1 \
