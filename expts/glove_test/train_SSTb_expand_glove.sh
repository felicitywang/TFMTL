python ../scripts/discriminative_driver.py \
       ...
       --datasets SSTb \
       --dataset_paths data/tf/single/SSTb/min_1_max_-1_vocab_-1_glove.6B.100d_expand \
       --class_sizes 5 \
       --vocab_size_file data/tf/single/SSTb/min_1_max_-1_vocab_-1_glove.6B.100d_expand/vocab_size.txt \
