...
if len(sys.argv) != 5:
  raise InputError(
    "Usage: python write_tfrecords_init.py dataset_name args_init_json_path "
    "init_json_dir vocab_dir")

dataset_name = sys.argv[1]
args_init_path = sys.argv[2]
json_dir = sys.argv[3]
...
with open(args_init_path)as file:
  args = json.load(file)
