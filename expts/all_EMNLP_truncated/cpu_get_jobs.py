...
if debug:
    ...
    root_dir = "/export/a08/fwang/tfmtl/expts/all_EMNLP_truncated/"
    data_dir = "/export/a08/fwang/tfmtl/expts/all_EMNLP_truncated/data/tf/"
    encoder_dir = "/export/a08/fwang/tfmtl/expts/all_EMNLP_truncated/encoder_files/"
    code_path = "/export/a08/fwang/tfmtl/expts/scripts/discriminative_driver.py"
    json_dir = "/export/a08/fwang/tfmtl/expts/all_EMNLP_truncated/data/json/"
...
def make_job(dataset, vocab, task, init_or_expand, finetune_or_freeze):
    ...
    result_dir = os.path.join(root_dir, 'early_results_42', dataset, name)
    make_dir(result_dir)

    job_dir = os.path.join(root_dir, 'early_jobs_42', dataset)
    make_dir(job_dir)
        ...
        for dataset in RUDER_TASKS:
            for vocab in ['train_1', 'all_0']:
                ...
                for init_or_expand in ['init']:
                    for finetune_or_freeze in ['finetune', 'freeze']:
